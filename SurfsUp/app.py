...
def homepage():
    ...
    return (
        ...
        f"Retrieve the minimum, maximum, and average temperatures from  the start date onward: /api/v1.0/<start><br>"
        f"Retrieve the minimum, maximum, and average temperatures from the start date to end date: /api/v1.0/<start>/<end><br>"
    )
